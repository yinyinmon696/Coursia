...
class BehaviourCoursesPage extends StatelessWidget {
  BehaviourCoursesPage({super.key});

  List<SubCategoryModel>? subCategoryList;
  List<CostModel> costList = [];
  List<UserLevelModel> userLevelList = [];

  final String? mainCategoryName = 'Behaviour';
  ...
  showButtomSheet(BuildContext context) {
    ...
    context
        .read<CoursesBloc>()
        .add(const GetSubCategoryList(mainSubName: 'Behaviour'));
